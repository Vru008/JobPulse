...
async function fromJSearch(query) {
  ...
  const url = `https://jsearch.p.rapidapi.com/search-v2?query=${encodeURIComponent(`${first} in USA`)}&num_pages=1&country=us&date_posted=week`;
